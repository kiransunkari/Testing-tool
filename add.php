...
$form = '			
			<table class="table" cellpadding="5">
			<form class=".ques-form" name="addinguser" method="POST" action="submit.php" enctype="multipart/form-data">
			<tr><td>Name :</td><td><input class="input" type="text" name="name"></td></tr>
			<tr><td>Roll Number :</td><td><input class="input" type="text" name="roll"></td></tr>
			<tr><td></td><td><input class="btn" type="submit" name="btn" value="SaveUser"> </td></tr>
			</form>
			</table>
';
break;
